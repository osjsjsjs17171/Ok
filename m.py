...
ascii_art = pyfiglet.figlet_format("   DREAM ")
print(L+ ascii_art)
print('\t\x1b[38;5;153m PayPal Charge 1$');
print(F+"□■"*30)
combo=input(X+'COMBO NAME :'+X)
y=open(f'{combo}',"+r")
tokbot = input(' 7559212061:AAG9f8ezNFPr1KS8MNFe_eeNRy1TWP8CZos: ')
idbot = input('ID : ')
start_num = 0
F = '\033[2;32m'
Z= '\033[2;31m'
